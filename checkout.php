			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<div class="row">
						<div class="col-50">
							<label for="state">Quận/Xã</label>
							<input type="text" id="state" name="state" placeholder ="Điền kí tự" class="form-control" pattern="^[a-zA-Z ]+$" required>
						</div>
						<div class="col-50">
							<label for="zip">Mã zip</label>
							<input type="text" id="zip" name="zip" placeholder ="Điền số" class="form-control" pattern="^[0-9]{6}(?:-[0-9]{4})?$" required>
						</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Đăng ký để nhận <strong>TIN MỚI</strong></p>
							<form >
