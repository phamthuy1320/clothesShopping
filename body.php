				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Quần áo nữ<br>Bộ sưu tập</h3>
								<a href="product.php?p=72" class="cta-btn">Đang bán <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>Quần áo nam<br>Bộ sưu tập</h3>
								<a href="product.php?p=72" class="cta-btn">Đang bán <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								<h3>Quần áo trẻ em<br>Bộ sưu tập</h3>
								<a href="product.php?p=79" class="cta-btn">Đang bán <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Quần áo nữ</a></li>
									<li><a data-toggle="tab" href="#tab1">Quần áo nam</a></li>
									<li><a data-toggle="tab" href="#tab1">quần áo trẻ em</a></li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Lịch sự</a></li>
									<li><a data-toggle="tab" href="#tab2">Áo sơ mi</a></li>
									<li><a data-toggle="tab" href="#tab2">Áo phông</a></li>
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">980.000 VND <del class="product-old-price">990.000 VND</del></h4>
									</div>
								</div>
								<!-- /product widget -->
